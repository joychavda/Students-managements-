...
<head>
    ...
    <title>Teacher Job Applying</title>
...
<div class="receipt-container">
    ...
    <img src="{{ asset('img/school logo.PNG') }}" class="school-logo" alt="School Logo">
        ...
        <div>
            ...
            <p><strong>Teacher Applying Later</strong></p>
        </div>
    </div>
    ...
    <div class="btn-container">
        <a href="{{ url('listteacher',$teacher->id)}}" class="btn btn-back"><i class="fa fa-arrow-left"></i> Back</a>
