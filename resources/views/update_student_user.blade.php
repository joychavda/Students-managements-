...
<form action="{{ url('edit_student_user') }}" method="POST" enctype="multipart/form-data" class="form-container">
    @csrf
        ...
        <div class="form-row">
            <div class="form-col">
                <div class="form-group">
                    ...
                    <input type="text" id="enrollment_number" name="enrollment_number" value="{{ $student->enrollment_number }}" readonly>
                </div>
            </div>
            <div class="form-col">
                <div class="form-group">
    ...
    <div class="form-section">
        ...
        <div class="form-row">
            <div class="form-col">
                <div class="form-group">
                    <label for="passport_image">Payment:</label>
                    <input type="text" id="passport_image" name="passport_image" value="{{ $student->payment ?? 'Paid' }}">
                </div>
            </div>
            <div class="form-col">
                <div class="form-group">
                    ...
                    <select name="payment_type" required style="width: 100%; padding: 15px; margin-bottom: 20px; border: 1px solid #ccc; border-radius: 5px; font-size: 18px; box-sizing: border-box;">
                        ...
                        <option value="Check" {{ ($student->payment_type ?? '') == 'Check' ? 'selected' : '' }}>Check</option>
                        <option value="Cash" {{ ($student->payment_type ?? '') == 'Cash' ? 'selected' : '' }}>Cash</option>
                        <option value="UPI" {{ ($student->payment_type ?? '') == 'UPI' ? 'selected' : '' }}>UPI</option>
                    </select>
                </div>
            </div>
            <div class="form-col">
                <div class="form-group">
                    ...
                    <input type="date" id="payment_date" name="payment_date" class="payment-date-field" value="{{ $student->payment_date ?? now()->toDateString() }}" readonly>
                </div>
            </div>
            <div class="form-col"></div>
        </div>
